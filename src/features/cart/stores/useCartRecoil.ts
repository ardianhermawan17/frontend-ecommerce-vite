...
import {cartItemsAtom} from "@feature/cart/stores/cartAtoms";
import {cartTotalCount, cartTotalPrice} from "@feature/cart/stores/cartSelectors";
...
export const useCartRecoil = () => {
    ...
    const clearCart = () => {
        setItems([]) // persistEffect will clear localStorage
    }

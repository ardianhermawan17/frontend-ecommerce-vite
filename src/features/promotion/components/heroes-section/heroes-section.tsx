...
import {useHeroesSection} from "@feature/promotion/components/heroes-section/use-heroes-section.ts";
...
export function HeroesSection() {
    ...
    return (
        <section
            ref={ref}
            className="heroes-section mt-8 py-20"
            aria-label="Triv Heroes"
        >
